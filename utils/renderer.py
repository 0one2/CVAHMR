...
#     def visualize_tb(self, pred_vertices, gt_vertices, pred_kps, gt_kps, camera_translation, images):
...
#             rend_img_pred = torch.from_numpy(np.transpose(self.__call__(pred_vertices[i], pred_kps[i], camera_translation[i], images_np[i]), (2,0,1))).float()            
#             rend_img_gt = torch.from_numpy(np.transpose(self.__call__(gt_vertices[i], gt_kps[i], camera_translation[i], images_np[i]), (2,0,1))).float()            

#             rend_imgs.append(images[i])
#             rend_imgs.append(rend_img_gt)
#             rend_imgs.append(rend_img_pred)
#         rend_imgs = make_grid(rend_imgs, nrow=2)
#         return rend_imgs

#     def __call__(self, vertices, kps, camera_translation, image):
#         material = pyrender.MetallicRoughnessMaterial(
#             metallicFactor=0.2,
#             alphaMode='OPAQUE',
#             baseColorFactor=(0.8, 0.3, 0.3, 1.0))
